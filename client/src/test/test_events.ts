...
import { CompleteStatus, CourseCategory } from 'core/enums/enums'
...
export default class TestEvents {
    ...
    private generate_events() {
        return [
            ...
            new Milestone().test_event(111140, 'Cambridge_Milestone_111140', [new GeoJSON(0.0, 0.0)], 100, 105, 2),
            new Milestone().test_event(111141, 'Cambridge_Milestone_111141', [new GeoJSON(0.0, 0.0)], 100, 105, 2),
